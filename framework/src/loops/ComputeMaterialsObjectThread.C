...
//         _bnd_material_props.initStatefulProps(
//             *_bnd_material_data[_tid],
//             _discrete_materials[Moose::FACE_MATERIAL_DATA].getActiveBlockObjects(_subdomain,
//             _tid), face_n_points, *elem, side);
//
//       if (_materials[Moose::FACE_MATERIAL_DATA].hasActiveBlockObjects(_subdomain, _tid))
//         _bnd_material_props.initStatefulProps(
//             *_bnd_material_data[_tid],
...
//
//       if
//       (_materials[Moose::NEIGHBOR_MATERIAL_DATA].hasActiveBlockObjects(neighbor->subdomain_id(),
//                                                                           _tid))
//         _neighbor_material_props.initStatefulProps(
