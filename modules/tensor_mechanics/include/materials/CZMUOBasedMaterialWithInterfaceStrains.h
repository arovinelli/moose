...
#ifndef CZMUOBASEDMATERIALWITHINTERFACESTRAINS_H
#define CZMUOBASEDMATERIALWITHINTERFACESTRAINS_H

#include "Material.h"
#include "DispJumpUO_QP.h"
#include "TensorOnInterfaceUO_QP.h"
#include "CZMTractionSeparationUOBase.h"
class CZMUOBasedMaterialWithInterfaceStrains;
template <>
InputParameters validParams<CZMUOBasedMaterialWithInterfaceStrains>();
/**
 *
 */
class CZMUOBasedMaterialWithInterfaceStrains : public Material
{
public:
  CZMUOBasedMaterialWithInterfaceStrains(const InputParameters & parameters);
...
protected:
  ...
  const TensorOnInterfaceUO_QP & _tensor_on_interface_UO;
  ...
  MaterialProperty<Real> & _master_normal_strain;
  MaterialProperty<Real> & _master_shear_strain;
  MaterialProperty<Real> & _slave_normal_strain;
  MaterialProperty<Real> & _slave_shear_strain;
...
#endif // CZMUOBASEDMATERIALWITHINTERFACESTRAINS_H
