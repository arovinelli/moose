...
class RankTwoRateScalarAux;

template <>
InputParameters validParams<RankTwoRateScalarAux>();

/**
 * RankTwoRateScalarAux uses the namespace RankTwoScalarTools to compute scalar
 * values from Rank-2 tensors.
 */
class RankTwoRateScalarAux : public NodalPatchRecovery
{
public:
  RankTwoRateScalarAux(const InputParameters & parameters);
