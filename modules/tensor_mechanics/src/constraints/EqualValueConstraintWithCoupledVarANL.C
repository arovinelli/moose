...
#include "EqualValueConstraintWithCoupledVarANL.h"
...
registerMooseObject("TensorMechanicsApp", EqualValueConstraintWithCoupledVarANL);

template <>
InputParameters
validParams<EqualValueConstraintWithCoupledVarANL>()
{
...
EqualValueConstraintWithCoupledVarANL::EqualValueConstraintWithCoupledVarANL(const InputParameters & parameters)
  : MortarConstraint(parameters), _funcJump(getFunction("funcJump"))
{
}

Real
EqualValueConstraintWithCoupledVarANL::computeQpResidual()
{
...
Real
EqualValueConstraintWithCoupledVarANL::computeQpResidualSide(Moose::ConstraintType res_type)
{
  switch (res_type)
  {
    case Moose::Master:
...
Real
EqualValueConstraintWithCoupledVarANL::computeQpJacobianSide(Moose::ConstraintJacobianType jac_type)
{
  switch (jac_type)
  {
